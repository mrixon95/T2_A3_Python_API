...
def get_team_members():
    ...
    while True:
        print(f"\nThe players are ordered by {team.ordering}. Would you like to reorder the players by one of their other statistics? (Y/N): ")
        entry = input().lower()
        if entry == 'y':
            while True:
...
Last name, Jersey, Position, Salary, Experience, Age, Weight, Height")
                ...
                print("Type in the name of the stat you would like to reorder by: ")
                stat = input().lower()
...
def order_standings(season_year):
    ...
    while True:
        print(f"\nThe standings are ordered by {team_standings.ordering}. Would you like to reorder the standings by one of the other columns? (Y/N): ")
        entry = input().lower()
        if entry == 'y':
            while True:
                print("Type in the name of the column you would like to reorder by: ")
                column = input().lower()
...
while not quit:
    ...
    try:
        ...
        print(f"Sorry your input was invalid. Please enter an integer between 1 and 6")
